...
export const getWeather = async (cityUI) => {
  return await axios.get(`http://dataservice.accuweather.com/forecasts/v1/daily/1day/${cityUI}?apikey=${API_KEY}&details=true&metric=true`);
  // console.log(res.data);    
};
